...
대규모 트래픽 상황에서도 안정적으로 재고를 관리하기 위해 **MSA**와 **Redis 기반 캐싱**을 사용했습니다. 또한, 분산 환경에서 주문 프로세스가 일관성 있게 진행되도록  **Choreography Saga패턴**을 사용하여 비동기 이벤트로 트랜잭션을 처리했습니다.
...
- Choreography Saga패턴을 적용하여 **분산 환경에서 안정적인 트랜잭션 관리**
- Kafka와 OpenFeign을 사용하여 외부 모듈 통신
...
- 개선을 통해 사용자 이탈률 10.73% 감소 및 사용자 경험 향상
